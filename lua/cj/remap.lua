...
Map("n", "<M-S-down>", function() vim.cmd.m("+1") end)
Map("i", "<M-S-down>", "<Esc>:m .+1<CR>i")
Map("v", "<M-S-down>", ":m '>+1<CR>gv")
Map("n", "<M-S-up>", function() vim.cmd.m("-2") end)
Map("i", "<M-S-up>", "<Esc>:m .-2<CR>i")
Map("v", "<M-S-up>", ":m '<-2<CR>gv")
...
Map("n", "<leader>nw", ":setl nowrap<CR>")
